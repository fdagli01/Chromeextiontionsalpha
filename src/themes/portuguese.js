...
export const portugueseTheme = defineTheme({
  ...
  stampSuccessLabel: 'REGISTADO! Seyir defterine işlendi — rüzgâr uygun, rota açık.',
  stampFailLabel: 'RUMO A CORRIGIR. Pusula yeniden ayarlandı; kelime rotaya geri alındı.',
